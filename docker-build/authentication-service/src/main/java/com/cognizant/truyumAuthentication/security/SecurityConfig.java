...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.and()
		.authorizeRequests()
		.antMatchers("/authentication-service/truyum/menu-items").anonymous()
		.antMatchers("/authentication-service/truyum/sign-up").permitAll()
		.antMatchers("/authentication-service/truyum/authenticate").permitAll();
